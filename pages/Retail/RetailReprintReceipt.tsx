          ...
          <View style={RetailStyles.retailFrame}>
            ...
            <View style={[GlobalStyles.frameMain,{padding: 10}]}>
              ...
              <View style={RetailStyles.pendingButtonsWrap}>
                <TouchableOpacity style={[GlobalStyles.button,GlobalStyles.buttonTertiary]} onPress={() => onPressNavigate('RetailOfficialReceipt')}>
                  <IconItem itype={'Ionicons'} iname={'print-outline'} isize={32} icolor={color.light} />
                  <View style={GlobalStyles.buttonTextWrap}><Text style={[GlobalStyles.buttonText]}>Reprint Receipt</Text></View>
                </TouchableOpacity>
              </View>
            </View>
            }
...
export default RetailReprintReceipt
