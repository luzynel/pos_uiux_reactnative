...
const Menu1 = () => (
  <ScrollView style={GlobalStyles.scrollViewContainar}>
    <View style={TakeOrderStyles.productList}>
      {/* product item */}
      <ProductItem_TakeOrder pEnabled={true} pTitle={'Original'} pPrice={'0'} />
...
const Menu2 = () => (
  <ScrollView style={GlobalStyles.scrollViewContainar}>
    <View style={TakeOrderStyles.productList}>
      {/* product item */}
      <ProductItem_TakeOrder pEnabled={true} pTitle={'coke regular'} pPrice={'0'} />
...
export default function ModifyOrder() {
  ...
  const [index, setIndex2] = React.useState(1);
