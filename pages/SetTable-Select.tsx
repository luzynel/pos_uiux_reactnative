import {StyleSheet,View,SafeAreaView,ScrollView,useWindowDimensions,Text,ActivityIndicator} from 'react-native';
...
const MainArea = () => (
  <ScrollView style={SetTableStyles.tableScrollView}>
    <View style={SetTableStyles.tablesMainArea}>
      <TableItem tid={'01'} ttype={'selected'} tpax={''} tname={''} />
      <TableItem tid={'02'} ttype={''} tpax={''} tname={''} />
...
const LobbyArea = () => (
  <ScrollView style={SetTableStyles.tableScrollView}>
    <View style={SetTableStyles.tablesMainArea}>
      <TableItem tid={'21'} ttype={''} tpax={''} tname={''} />
...
export default function SetTableSelect() {
